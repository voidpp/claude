...
import { DashboardInput, useRemoveWidgetMutation, useSaveDashboardMutation, useSaveWidgetMutation, useSettingsQuery, Widget, WidgetInput } from "./graphql-types-and-hooks";
